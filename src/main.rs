...
fn main() -> std::io::Result<()> {
    ...
    loop {
        let offset = dissasemble_8080(&buffer, pc);
        pc += offset;
...
fn dissasemble_8080(buffer: &Vec<u8>, pointer: usize) -> usize {
    let code = &buffer[pointer];
    let mut opbytes = 1;
    ...
    match code {
        ...
        0x05 => println!("DCR    B"),
        0x06 => {
            println!("MVI    B,{:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0x07 => println!("RLC"),
        0x08 => println!("-"),
        ...
        0x0d => println!("DCR    C"),
        0x0e => {
            println!("MVI    C,{:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0x0f => println!("RRC"),
        //----------------------------------------------
        ...
        0x15 => println!("DCR    D"),
        0x16 => {
            println!("MVI    D,{:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0x17 => println!("RAL"),
        0x18 => println!("-"),
        ...
        0x1d => println!("DCR    E"),
        0x1e => {
            println!("MVI    E,{:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0x1f => println!("RAR"),
        //----------------------------------------------
        ...
        0x25 => println!("DCR    H"),
        0x26 => {
            println!("MVI    H,{:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0x27 => println!("DAA"),
        0x28 => println!("-"),
        ...
        0x2d => println!("DCR    L"),
        0x2e => {
            println!("MVI    L,{:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0x2f => println!("CMA"),
        //----------------------------------------------
        ...
        0x35 => println!("DCR    M"),
        0x36 => {
            println!("MVI    M,{:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0x37 => println!("STC"),
        0x38 => println!("-"),
        ...
        0x3d => println!("DCR    A"),
        0x3e => {
            println!("MVI    A,{:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0x3f => println!("CMC"),
        //----------------------------------------------
        ...
        0xc5 => println!("PUSH   B"),
        0xc6 => {
            println!("ADI    {:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0xc7 => println!("RST    0"),
        0xc8 => println!("RZ"),
        ...
        0xce => {
            println!("ACI    {:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0xcf => println!("RST    1"),
        //----------------------------------------------
        ...
        0xd3 => {
            println!("OUT    {:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0xd4 => {
            println!(
        ...
        0xd5 => println!("PUSH   D"),
        0xd6 => {
            println!("SUI    {:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0xd7 => println!("RST    2"),
        0xd8 => println!("RC"),
        ...
        0xdb => {
            println!("IN     {:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0xdc => {
            println!(
        ...
        0xdd => println!("-"),
        0xde => {
            println!("SBI    {:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0xdf => println!("RST    3"),
        //----------------------------------------------
        ...
        0xe5 => println!("PUSH   H"),
        0xe6 => {
            println!("ANI    {:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0xe7 => println!("RST    4"),
        0xe8 => println!("RPE"),
        ...
        0xed => println!("-"),
        0xee => {
            println!("XRI    {:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0xef => println!("RST    5"),
        //----------------------------------------------
        ...
        0xf6 => {
            println!("ORI    {:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0xf7 => println!("RST    6"),
        0xf8 => println!("RM"),
        ...
        0xfd => println!("-"),
        0xfe => {
            println!("CPI    {:02x}", buffer[pointer + 1]);
            opbytes = 2;
        }
        0xff => println!("RST    7"),
    }
